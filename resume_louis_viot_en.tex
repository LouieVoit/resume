...
\section*{Skills}
\begin{itemize}
	\item \textbf{Programming :} C++, Java, C, Python, Fortran, MPI, Cuda, OCamL, Qt, Haskell, ADA, \LaTeX
...
\begin{itemize}
    \item \textbf{``Static load balanced molecular-continuum flow simulation for inhomogeneous particle systems and heterogeneous hardware``} in Journal of Computational Science, 2026
